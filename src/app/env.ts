...
const DEFAULT_RECONCILIATION_HISTORY_RETENTION_ASSUMPTION_DAYS = 365;
...
export function loadAppConfig(env: NodeJS.ProcessEnv = process.env): AppConfig {
  ...
  return {
    ...
    reconciliationHistoryRetentionAssumptionDays: parseNumber(
      env.RECONCILIATION_HISTORY_RETENTION_ASSUMPTION_DAYS,
      DEFAULT_RECONCILIATION_HISTORY_RETENTION_ASSUMPTION_DAYS,
    ),
