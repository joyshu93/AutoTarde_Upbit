import type { ExecutionMode, ExecutionPolicy, LiveExecutionGate, SupportedAsset } from "../domain/types.js";
...
const DEFAULT_TOTAL_EXPOSURE_CAP = 0.95;
...
export function buildExecutionPolicy(config: AppConfig): ExecutionPolicy {
  return {
