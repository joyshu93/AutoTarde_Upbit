...
CREATE TABLE IF NOT EXISTS operator_notifications (
  ...
  notification_type TEXT NOT NULL CHECK (notification_type IN ('ORDER_REJECTED', 'ORDER_SUBMISSION_FAILED', 'RECONCILIATION_DRIFT_DETECTED', 'SCHEDULER_STARTUP_BLOCKED', 'SCHEDULER_ORDER_REJECTED', 'SCHEDULER_ORDER_SUBMITTED', 'SCHEDULER_RUN_FAILED', 'SCHEDULER_RUN_SKIPPED', 'SYNC_FAILED')),
