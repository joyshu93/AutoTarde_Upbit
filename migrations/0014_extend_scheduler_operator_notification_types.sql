...
ALTER TABLE operator_notifications RENAME TO operator_notifications_legacy_v4;
...
SELECT
  ...
  delivered_at,
  last_error
FROM operator_notifications_legacy_v4;

ALTER TABLE operator_notification_delivery_attempts RENAME TO operator_notification_delivery_attempts_legacy_v4;
...
SELECT
  ...
  error_message,
  created_at
FROM operator_notification_delivery_attempts_legacy_v4;

DROP TABLE operator_notification_delivery_attempts_legacy_v4;

DROP TABLE operator_notifications_legacy_v4;
